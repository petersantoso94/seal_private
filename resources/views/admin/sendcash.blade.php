        ...
        <div class='col-xs-8'>
            ...
            <form>
                <div class="form-group">
                    ...
                    <select data-placeholder="Choose users..." class="chosen-select form-control" name="users" id="users"  multiple="" tabindex="-1" >
                        <option></option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id='cash-nominal' class='form-control'>
                </div>
