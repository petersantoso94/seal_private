...
<!--<link href="{{ URL::asset('bower_components/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">-->
    ...
    <script type="text/javascript"
            src="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/config.js?t=HBDF"></script>
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/skins/moono-lisa/editor.css?t=HBDF">
    <script type="text/javascript"
            src="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/lang/en.js?t=HBDF"></script>
    <script type="text/javascript"
            src="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/styles.js?t=HBDF"></script>
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/plugins/scayt/skins/moono-lisa/scayt.css">
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/plugins/scayt/dialogs/dialog.css">
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/plugins/tableselection/styles/tableselection.css">
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/plugins/wsc/skins/moono-lisa/wsc.css">
    <script type="text/javascript"
            src="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/plugins/image/dialogs/image.js?t=HBDF"></script>
    <link rel="stylesheet" type="text/css"
          href="https://adminlte.io/themes/AdminLTE/bower_components/ckeditor/skins/moono-lisa/dialog.css?t=HBDF">
    <style>
        table {
...
<div class="wrapper">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{url::route('logoutadmin')}}" class="btn btn-default btn-flat">Sign
                                        out</a>
                                </div>
                            </li>
                        </ul>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @if(Session::get('role') == 0)
                    <li <?php if (isset($page)) if ($page === 'Approve User') echo 'class="active"'; ?>><a
                                href="{{url('loginadmin')}}"><i class="fa fa-link"></i> <span>Approve User</span></a>
                    </li>
                ...
                <li <?php if (isset($page)) if ($page === 'Edit Fan Art') echo 'class="active"'; ?>><a
                            href="{{url('editfanart')}}"><i class="fa fa-link"></i> <span>Edit Fan Art</span></a></li>
                <li <?php if (isset($page)) if ($page === 'Edit Costume') echo 'class="active"'; ?>><a
                            href="{{url('editcostume')}}"><i class="fa fa-link"></i> <span>Edit Costume</span></a></li>
                <li <?php if (isset($page)) if ($page === 'Edit News') echo 'class="active"'; ?>><a
                            href="{{url('editnews')}}"><i class="fa fa-link"></i> <span>Edit News</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
    ...
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            ...
            <li>
                <a href="#cont                                                                                                                                                                                                   rol-sidebar-settings-tab"
